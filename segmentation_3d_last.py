"""3D segmentation last (stable baseline).

This is the stable 3D baseline used for iteration comparisons.
It trains a tiny 3D U-Net on synthetic sphere volumes.
"""
